<div aria-hidden="true"
    ...
    <div class="relative w-full max-w-2xl h-full md:h-auto">
        <!-- Modal content -->
        <form action="/nilai/store" class="relative bg-white rounded-lg shadow dark:bg-gray-700" method="POST">
            @csrf
            <!-- Modal header -->
                ...
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input
                            ...
                            id="NilaiId" name="NilaiId" type="number">
                        @error('NilaiId')
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            id="NilaiUh" name="NilaiUh" step="any" type="number" value="{{ old('NilaiUh') }}">
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                        ...
                        <input
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            id="NilaiPraktek" name="NilaiPraktek" step="any" type="number"
            ...
            <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                <button
                    ...
                    href="/nilai" type="submit">Save all</button>
            </div>
        </form>
    </div>
