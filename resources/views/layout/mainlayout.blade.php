            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
                <ul
                    ...
                    @guest
                        @if (Route::has('login'))
                            <li class="nav-item">
                                <a class="block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-sky-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent nav-link"
