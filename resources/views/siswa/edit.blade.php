@foreach ($siswa as $g)
    <div aria-hidden="true"
        ...
        id="Edit{{ $g->NIS }}" tabindex="-1">
        <div class="relative w-full max-w-2xl h-full md:h-auto">
            <!-- Modal content -->
            <form action="/siswa/{{ $g->NIS }}" class="relative bg-white rounded-lg shadow dark:bg-gray-700"
                method="POST">
                @method('put')
                @csrf
                <!-- Modal header -->
                <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                    ...
                    <button
                        ...
                        data-modal-toggle="Edit{{ $g->NIS }}" type="button">
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input
                                    ...
                                    value="{{ $g->SiswaNama, old('SiswaNama') }}">
                                @error('SiswaNama')
                                    <div class="p-4 mb-4 text-sm text-yellow-700 bg-yellow-100 rounded-lg dark:bg-yellow-200 dark:text-yellow-800"
                                        role="alert">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <textarea
                                ...
                                id="Alamat" name="Alamat" type="text">{{ $g->Alamat, old('Alamat') }}</textarea>
                            @error('Alamat')
                                <div class="p-4 mb-4 text-sm text-yellow-700 bg-yellow-100 rounded-lg dark:bg-yellow-200 dark:text-yellow-800"
                                    role="alert">
